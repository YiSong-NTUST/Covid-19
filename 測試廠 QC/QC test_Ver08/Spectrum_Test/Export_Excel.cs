    ...
    class Export_Excel
    {
        ...
        public static void CreatExcel(string path, string which)
        {
            ...
            else if(which == "QC")
            {
                ...
                range3.Merge(true);
                range3.Value2 = "馬達誤差";
                Excel.Range range4 = worksheet.Range[worksheet.Cells[1, "V"], worksheet.Cells[1, "X"]];
                range4.Merge(true);
                range4.Value2 = "LED A燈資訊";
                Excel.Range range5 = worksheet.Range[worksheet.Cells[1, "Y"], worksheet.Cells[1, "AA"]];
                range5.Merge(true);
                range5.Value2 = "LED B燈資訊";
                Excel.Range range6 = worksheet.Range[worksheet.Cells[1, "AB"], worksheet.Cells[1, "AD"]];
                range6.Merge(true);
                range6.Value2 = "光譜 A燈資訊";
                Excel.Range range7 = worksheet.Range[worksheet.Cells[1, "AE"], worksheet.Cells[1, "AG"]];
                range7.Merge(true);
                ...
                worksheet.Cells[2, "X"] = "EXP";
                worksheet.Cells[2, "Y"] = "LED-B";
                worksheet.Cells[2, "Z"] = "LED-B STD";
                worksheet.Cells[2, "AA"] = "EXP";
                worksheet.Cells[2, "AB"] = "Spectrum-A";
                worksheet.Cells[2, "AC"] = "Spectrum-A STD";
                worksheet.Cells[2, "AD"] = "EXP";
                worksheet.Cells[2, "AE"] = "Spectrum-B";
                worksheet.Cells[2, "AF"] = "Spectrum-B STD";
                worksheet.Cells[2, "AG"] = "EXP";
                #endregion
            }
            //=========================================================================
        ...
        public static void WriteToExcel(string excelName, IEnumerable<QCreport> QCReport_data)
        {
            ...
            foreach (var data in QCReport_data)
            {
                ...
                mysheet.Cells[maxrow, "X"] = data.LED_A[2];
                mysheet.Cells[maxrow, "Y"] = data.LED_B[0];
                mysheet.Cells[maxrow, "Z"] = data.LED_B[1];
                mysheet.Cells[maxrow, "AA"] = data.LED_B[2];
                mysheet.Cells[maxrow, "AB"] = data.Spectrum_A[0];
                mysheet.Cells[maxrow, "AC"] = data.Spectrum_A[1];
                mysheet.Cells[maxrow, "AD"] = data.Spectrum_A[2];
                mysheet.Cells[maxrow, "AE"] = data.Spectrum_B[0];
                mysheet.Cells[maxrow, "AF"] = data.Spectrum_B[1];
                mysheet.Cells[maxrow, "AG"] = data.Spectrum_B[2];
            }
            //============================================================
