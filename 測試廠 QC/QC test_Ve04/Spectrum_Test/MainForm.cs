        ...
        public void export_PDF()
        {
          ...
          //  itemname9.HorizontalAlignment = Element.ALIGN_CENTER;
           ...
           // itemname14.HorizontalAlignment = Element.ALIGN_CENTER;
            ...
            PdfPCell itemname16 = new PdfPCell(new Phrase("", myenFont));
            ...
            PdfPCell item4 = new PdfPCell(new Phrase("Pass / NG", myenFont));
            item4.Colspan = 4;
            ...
            PdfPCell item6 = new PdfPCell(new Phrase("Pass / NG", myenFont));
            item6.Colspan = 4;
            ...
            PdfPCell item8 = new PdfPCell(new Phrase("Pass / NG", myenFont));
            item8.Colspan = 4;
            ...
            PdfPCell item10 = new PdfPCell(new Phrase("Pass / NG", myenFont));
            item10.Colspan = 4;
                    ...
                    while (flag)
                    {
                        switch (iTask)
                        {
                            ...
                            case 30:
                                ...
                                {
                                    Xts_T2 = double.Parse(T2_txt.Text);
