    ...
    public partial class MainForm : Form
    {
        ...
        private async void btnBT_Test_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                BLE_test_pass_lb.BackColor = Color.Lime;
            ...
            catch (Exception ex)
            {
                BeginInvoke((Action)(() =>
                {
                    ...
                    BLE_test_ng_lb.BackColor = Color.Red;
                    WriteBLEExcel(operator_txt.Text, "", "", pass_ng[0]);
                }));
            }
        }
                    ...
                    for (loop_index = 0; loop_index < test_ble_loop_count; loop_index++)
                    {
                        ...
                        for (int i = 0; i < 3; i++)
                        {
                            ...
                            foreach (KeyValuePair<string, BLE_Device> kvp in temp)
                            {
                                ...
                                BeginInvoke((Action)(() =>
                                {
                                    status_lb.Text = string.Format("{0} {1}", kvp.Key, kvp.Value.RSSI);
                                }));
                        ...
                        if (lst_dev.Count <= 0)
                        {
                            BeginInvoke((Action)(() =>
                            {
                                status_lb.Text = "No device found in Range.";
                            }));
                        ...
                        BeginInvoke((Action)(() =>
                        {
                            status_lb.Text = string.Format("target_dev {0} - {1}", target_dev.UUID, target_dev.RSSI.ToString());
                        }));
                        ...
                        if (CMD_BLE_Connect(target_dev) == CMD_RET_OK)
                        {
                            ...
                            for (int i = 0; i < test_ble_cmd_count; i++)
                            {
                                if (CMD_BLE_TEST_CMD(target_dev) != CMD_RET_OK)
                                {
                                    ...
                                    BeginInvoke((Action)(() =>
                                    {
                                        status_lb.Text = "BLE test cmd fail.";
                                    }));
                        ...
                        else
                        {
                            BeginInvoke((Action)(() =>
                            {
                                status_lb.Text = "Connect device error.";
                            }));
                        ...
                        BeginInvoke((Action)(() =>
                        {
                            status_lb.Text = string.Format("BLE test Loop {0} OK.", loop_index + 1);
                        }));
